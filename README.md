...
※ シンボリックリンクではなくコピーする場合は `cp -R skills/next2d-development-assistant .agents/skills/next2d-development-assistant` を使用してください。
...
If you prefer copying instead of symlinking, use `cp -R skills/next2d-development-assistant .agents/skills/next2d-development-assistant`.
